...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to DevLUp Inc, 397 DeSoto Parkway, Satellite Beach, FL, 32937 .
...
- **Website** refers to DevLUp, accessible from [https://devlup.org/](https://devlup.org/)
...
- By email: contact@devlup.org

- By visiting this page on our website: [https://devlup.org/r/discord](https://devlup.org/r/discord)
